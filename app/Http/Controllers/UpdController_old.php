...
class UpdController extends Controller
{
    ...
    public function getData($type,$id)
    {
        ...
        $toid = "1";
        $toid = file_get_contents("http://192.168.0.65/zod/edo/edoSbis.php?a=3&inn=" . $goods[0]->inn . (strlen($goods[0]->inn)==10?"&kpp=" . $goods[0]->kpp:"" ). "&k=lK_wh__rFg2");
        ...
        if (count($regionCode)==0){return response()->view('message', ["message" => "Регион не соответствует формату:".$Uadress],200)->header('EDO-Error', "region error");}
